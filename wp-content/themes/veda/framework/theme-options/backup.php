    ...
    <div class="bpanel-main-content">
        ...
        <div id="tab1" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-title">
                    <h3><?php esc_html_e('Transfer Theme Options Data', 'veda');?></h3>
                </div>

                <div class="box-content">
                	<div><?php
						esc_html_e("You can tranfer the saved options data between different installs by copying the text inside the text box. To import data from another install, replace the data in the text box with the one from another install and click 'Import Options'", 'veda');?>
                    </div>
                    <div class="clar"></div>
                    <div class="hr_invisible"></div>
                	<?php $data = get_option('veda-opts'); ?>
                    <textarea id="export_data" rows="13" cols="15"><?php echo serialize($data); ?></textarea>
                    <div class="clear"></div>
                    <div class="hr_invisible"></div>
                    <a href="#" id="dttheme_import_button" class="bpanel-button black-btn" title="<?php esc_attr_e('Restore Options', 'veda');?>"><?php esc_html_e('Import Options', 'veda');?></a>
                </div>
            </div><!-- .bpanel-box end -->
        </div><!--tab1-backup end-->
