        ...
        <div id="tab1" class="tab-content">
            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="column one-third"><label><?php esc_html_e('Site Title Color', 'veda');?></label></div>
                    <div class="column two-third last"><?php
                        $name  =  "dttheme[colors][site-color]";
                        $value =  (veda_option('colors','site-color') != NULL) ? veda_option('colors','site-color') :"";
                        veda_admin_color_picker_two($name,$value);?>
                        <p class="note"><?php esc_html_e('Pick a custom site title color of the body.(e.g. #a314a3)', 'veda');?></p>
                    </div>
                    <div class="hr"></div>
