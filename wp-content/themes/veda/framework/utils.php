 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_default_option')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_is_plugin_active')) {
...
if (!function_exists('veda_is_plugin_active_for_network')) {
...
if (!function_exists('veda_show_footer_widgetarea')) {
