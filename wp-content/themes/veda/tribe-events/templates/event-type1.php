    ...
    <p class="event-schedule"><?php
      echo tribe_get_start_date ( $event_id, true, $date_format ).$raw_separator.tribe_get_start_time ( $event_id, $time_format ).' - '.tribe_get_end_date ( $event_id, true, $date_format ).$raw_separator.tribe_get_end_time ( $event_id,  $time_format );
      ...
      <div class="event-image-wrapper">
          <div class="date-wrapper">
              <p class="event-datetime">
                  ...
                  <i class="fa fa-clock-o"></i><?php echo tribe_get_start_time ( $event_id,  $time_format ). ' - '.tribe_get_end_time ( $event_id,  $time_format ); ?>
              </p>
              <p class="event-venue">
    ...
    <div class="dt-sc-one-third column">
        ...
        <ul class="event-details">
            <li><dt><?php esc_html_e('Start:', 'veda'); ?></dt><?php echo tribe_get_start_date ( $event_id, true, $date_format ).$raw_separator.tribe_get_start_time ( $event_id,  $time_format ); ?></li>
            <li><dt><?php esc_html_e('End:', 'veda'); ?></dt><?php echo tribe_get_end_date ( $event_id, true, $date_format ).$raw_separator.tribe_get_end_time ( $event_id,  $time_format ); ?></li>
            <?php if ( tribe_get_cost() ) : ?>
                <li><dt><?php esc_html_e('Cost:', 'veda'); ?></dt><?php echo tribe_get_cost( $event_id, true ); ?></li>
            <?php endif; ?>
            <li><?php echo tribe_get_event_categories( $event_id, array( 'before' => '', 'sep' => ', ',  'after' => '', 'label' => '', 'label_before' => '<dt class="cat">'.esc_html__('Event Category', 'veda'), 'label_after'  => '</dt>', 'wrap_before' => '<div class="cat-wrapper">', 'wrap_after' => '</div>' )); ?></li>
            <li><?php echo tribe_meta_event_tags( esc_html__('Event Tags:', 'veda'), ', ', false ); ?></li>
            <?php
