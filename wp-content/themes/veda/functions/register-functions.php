...
if( veda_option('pageoptions','enable-comingsoon') ):
	...
	if (!function_exists('veda_rand_css')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_slider')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_pagination')) {
 ...
 * Breadcrumbs
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_breadcrumbs')) {
 ...
 * Breadcrumb Section
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_breadcrumb_section')) {
function veda_breadcrumb_section($id, $post_type ) {
	...
	if( isset($bcrumb) && $bcrumb == 'true' ) :
		...
		$co = array_key_exists('sub-title-bg-color', $settings) ? $settings['sub-title-bg-color'] : '';
...
if (!function_exists('veda_breadcrumb_section_with_class')) {
...
if (!function_exists('veda_events_title')) {
...
if (!function_exists('veda_excerpt')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_wp_kses')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_array_search')) {
 ...
 * Theme Header Logo
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_header_logo')) {
 ...
 * Theme Comment Style
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_comment_style')) {
 ...
 * Theme show sidebar
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_show_sidebar')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_global_variables')) {
...
* break oembeds.
*/
if (!function_exists('veda_undo_recurrence_oembed_logic')) {
