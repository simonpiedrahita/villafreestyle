...
if (!function_exists('veda_enqueue_scripts')) {
function veda_enqueue_scripts() {
	...
	$cookiebar = veda_option('privacy', 'enable-cookie-msgbar');
		if( isset($cookiebar) ) {
...
* --------------------------------------------------------------------------- */
if (!function_exists('veda_viewport')) {
...
* --------------------------------------------------------------------------- */
if (!function_exists('veda_scripts_custom')) {
...
if (!function_exists('veda_enqueue_styles')) {
function veda_enqueue_styles() {
	...
	// wp_enqueue_style ---------------------------------------------------------------
	wp_enqueue_style( 'reset',			VEDA_THEME_URI .'/css/reset.css', false, THEME_VERSION, 'all' );
	...
	$cookie_bar = veda_option('privacy', 'enable-cookie-msgbar');
		if( isset($cookie_bar) ) {
			wp_enqueue_style( 'veda-cookie-css', VEDA_THEME_URI .'/css/cookieconsent.css', false, THEME_VERSION, 'all' );
		}

		wp_enqueue_style( 'veda-popup-css', 		VEDA_THEME_URI .'/functions/js/magnific/magnific-popup.css', false, THEME_VERSION, 'all' );
 ...
 * Styles Minify
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_styles_minify')) {
 ...
 * Styles Dynamic
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_styles_dynamic')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_styles_custom_font')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_fonts_selected')) {
...
if (!function_exists('veda_appearance_css')) {
 ...
 * --------------------------------------------------------------------------- */
if (!function_exists('veda_body_classes')) {
