...
if (!function_exists('veda_product_has_gallery')) {
...
if (!function_exists('veda_woo_image_dimensions')) {
...
if (!function_exists('veda_woo_before_subcategory')) {
...
if (!function_exists('veda_woocommerce_before_subcategory_title')) {
...
if (!function_exists('veda_woocommerce_after_subcategory_title')) {
...
if (!function_exists('veda_woo_after_subcategory')) {
...
if (!function_exists('veda_woo_shop_overview_extra_div')) {
...
if (!function_exists('veda_woo_show_product_loop_sale_flash')) {
...
if (!function_exists('veda_woo_shop_overview_show_price')) {
...
if (!function_exists('veda_woo_shop_overview_extra_div_close')) {
...
if (!function_exists('veda_woo_after_shop_loop')) {
...
if (!function_exists('veda_woo_output_related_products')) {
...
if (!function_exists('veda_woo_output_upsells')) {
...
if (!function_exists('veda_woo_show_product_sale_flash')) {
...
if (!function_exists('veda_woo_close_product_wrapper')) {
