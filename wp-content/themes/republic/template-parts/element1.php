...
$getcateid1 = get_theme_mod('republic_catechoose1'); ?>
	...
	<!---Title of Index Elements-->
		...
		<a href="<?php echo esc_url( get_category_link( $getcateid1 ) ); ?>" class="viewposts" title="<?php echo get_cat_name($getcateid1); ?>"><?php esc_attr('View all','republic'); ?> <i class="fa fa-caret-right"></i></a>
	</div>
