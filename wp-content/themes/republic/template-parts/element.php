...
$getcateid2 = get_theme_mod('republic_catechoose2'); 
 ?>
	...
	<!---Title of Index Elements-->
		...
		<a href="<?php echo esc_url( get_category_link( $getcateid2 ) ); ?>" class="viewposts" title="<?php echo get_cat_name($getcateid2); ?>"><?php esc_attr('View all','republic'); ?> <i class="fa fa-caret-right"></i></a>
	</div>
